...
function Tab1() {
  ...
  },
  {
    ...
    name: <ul style={{'listStyle':'none'}}>
        <li>Robert Brown</li>
        <li>David Black</li>
        <li>David Black</li>
    </ul>,
    flight: <ul style={{'listStyle':'none'}}>
        <li>| FA-5832</li>
        <li>| FA-5832</li>
        <li>| FA-5832</li>
    </ul>,
    startTime: <ul style={{'listStyle':'none'}}>
    <li>7:30 AM</li>
    <li>7:30 AM</li>
    <li>7:30 AM</li>
</ul>,
...
:
    ...
    <div className='scheduleUpdate'>
        ...
        <p>
        “Flight  #05042024  (YVR → JFK) is delayed by 2 hours due to severe weather, with a new departure time of 11:20 AM.”
        </p>
        {/* <Button>
            Details
        </Button> */}
